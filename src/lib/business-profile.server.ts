...
const FIELDS =
  "business_name, phone, email, service_area, is_texas_commissioned, is_bonded, eo_insured_amount, is_nna_certified, readiness_check_hours, service_pricing, ai_chat_widget_enabled";
